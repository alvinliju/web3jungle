  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <p className="text-4xl font-bold bg-gradient-to-r from-emerald-400 to-green-500 text-transparent bg-clip-text">
                500+
              </p>
              <p className="text-zinc-400">Projects Listed</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold bg-gradient-to-r from-emerald-400 to-green-500 text-transparent bg-clip-text">
                50K+
            ...
            <div className="text-center">
              ...
              <p className="text-zinc-400">Monthly Votes</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-bold bg-gradient-to-r from-emerald-400 to-green-500 text-transparent bg-clip-text">
                25+
              </p>
              <p className="text-zinc-400">Blockchains</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">How Web3Jungle Works</h2>
            <p className="text-zinc-400 text-lg">Simple, transparent, and community-driven</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8 relative">
            <div className="hidden md:block absolute top-24 left-1/3 right-1/3 h-0.5 bg-gradient-to-r from-transparent via-emerald-800 to-transparent"></div>
